...
> Регистр и приоритет: ru-text ориентирован на общий и веб-текст, поэтому в типографике опирается прежде всего на нормы экранной и веб-типографики — «Ководство» А. Лебедева (ведущий ориентир для веб-текста), а также «Типографику и вёрстку» и «Советы» Бюро Горбунова. Где эти источники дают норму для общего и веб-текста, она имеет приоритет. Печатно-редакторские справочники — «Справочник издателя и автора» Мильчина и Чельцовой, справочники Розенталя — применяются для редакторско-издательских конвенций и там, где веб-ориентированные источники вопрос не покрывают. Метрологический стандарт (ГОСТ 8.417-2024) — только как контекстный вариант для научно-технических документов. Приоритет здесь — редакторский выбор ru-text по регистру, а не одобрение со стороны авторов. Ниже это затрагивает знак процента (R37); провенанс слитного написания остаётся за Шульмейстером и Гиленсоном и де-факто нормой Рунета.
...
### E.4. Даты
R59. Полная дата в тексте: `15 марта 2026 года`. Короткая для таблиц/форм: `15.03.2026`. Исключение — дата в порядке год-месяц-день (`2026-07-13`, с любым дефисом) в ячейке таблицы остаётся как есть: R59 выбирает между двумя русскими формами и третьей не касается. Вне ячейки форма разрешения не даёт: `совещание состоится 2026-09-15` → `совещание состоится 15 сентября 2026 года`.
